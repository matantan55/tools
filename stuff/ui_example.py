...
class App(customtkinter.CTk):
    ...
    def __init__(self):
        ...
        self.button_1 = customtkinter.CTkButton(master=self.frame_left, command=self.button_event)
        self.button_1.grid(row=2, column=0, pady=10, padx=20)

        self.button_2 = customtkinter.CTkButton(master=self.frame_left, command=self.button_event)
        self.button_2.grid(row=3, column=0, pady=10, padx=20)

        self.button_3 = customtkinter.CTkButton(master=self.frame_left, command=self.button_event)
